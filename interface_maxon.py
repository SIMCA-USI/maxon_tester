...
class Ui_InterfazMAXON(object):
    def setupUi(self, InterfazMAXON):
        ...
        self.frame_general.setGeometry(QtCore.QRect(20, 80, 761, 501))
        ...
        self.init_button.setGeometry(QtCore.QRect(20, 10, 151, 51))
        self.init_button.setObjectName("init_button")
        self.frame_12 = QtWidgets.QFrame(self.frame_general)
        self.frame_12.setGeometry(QtCore.QRect(0, 70, 191, 331))
        ...
        self.frame_following.setGeometry(QtCore.QRect(0, 460, 369, 52))
        ...
        self.frame_speed.setGeometry(QtCore.QRect(0, 410, 369, 52))
        ...
        self.vel_giro = QtWidgets.QSlider(self.frame_3)
        self.vel_giro.setMaximum(5)
        self.vel_giro.setOrientation(QtCore.Qt.Vertical)
        self.vel_giro.setTickPosition(QtWidgets.QSlider.TicksAbove)
        self.vel_giro.setTickInterval(1)
        self.vel_giro.setObjectName("vel_giro")
        self.horizontalLayout_2.addWidget(self.vel_giro)
    ...
    def retranslateUi(self, InterfazMAXON):
        ...
        self.label_8.setText(_translate("InterfazMAXON", "1000"))
        self.label_7.setText(_translate("InterfazMAXON", "100"))
        self.label_6.setText(_translate("InterfazMAXON", "50"))
        self.label_5.setText(_translate("InterfazMAXON", "20"))
        self.label_2.setText(_translate("InterfazMAXON", "10"))
        self.label.setText(_translate("InterfazMAXON", "5"))
